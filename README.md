...
+ Modifica aquest fitxer README.md afegint una línia amb el teu nom directament a GitHub.
+ Fes un commit dels canvis
+ Al repositori local, edita el fitxer README.md afegint una línia amb un missatge de presentació teu, sense haver fet un pull prèviament.
+ Fes un commit dels canvis
